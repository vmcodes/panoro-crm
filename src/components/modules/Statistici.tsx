...
export default function Statistici({ modules, setModules }: Props) {
    // TODO
    return (
            ...
            <div className="lg:hidden inline-block">
                <button
                    onClick={() =>
                        setModules({
                            ...modules,
                            statistici: !modules.statistici,
                        })
                    }
                    className="w-screen"
                >
                    <div className="mx-6 text-center">
                        <div className="bg-lightgreen text-center flex justify-center w-full rounded-md">
                            <img src="/imgs/module4.svg" alt="module" className="p-6" />
                            <h3 className="text-lg font-bold mt-6">Modul pentru statistici</h3>
