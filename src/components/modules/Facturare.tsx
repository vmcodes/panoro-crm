                ...
                <div className="w-full flex justify-center">
                    <div className="w-3/4 m-6 text-center">
                        <div className="text-center flex justify-center w-full">
                            <img src="/imgs/module3.svg" alt="module" className="bg-purple p-6 rounded-md" />
                        </div>

                        <h3 className="text-lg font-bold mt-6">Modul Facturare</h3>
            ...
            <div className="lg:hidden inline-block">
                <button
                    onClick={() =>
                        setModules({
                            ...modules,
                            facturare: !modules.facturare,
                        })
                    }
                    className="w-screen"
                >
                    <div className="mx-6 text-center">
                        <div className="bg-purple text-center flex justify-center w-full rounded-md">
                            <img src="/imgs/module3.svg" alt="module" className="p-6" />
                            <h3 className="text-lg font-bold mt-6">Modul de facturare</h3>
